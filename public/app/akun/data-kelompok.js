...
function TombolBatal() {
    ...
    $("#akun_id").val("").removeClass('error');
    $("#akun").val("").removeClass('error');
...
$(function () {
    $("#myForm").validate({
        ...
        messages: {
            ...
            akun_id: "Silahkan pilih Akun terlebih dahulu",
            akun: "Silahkan pilih Akun terlebih dahulu",
            kelompok: "Silahkan isi kelompok"
        }
    })
});
...
function getAkun() {
    $.ajax({
        ...
        success: function (data) {
            CekAuth(data);
            $("#akun").html("").append("<option value=''>Pilih Akun</option>")
            $.each(data, function (index, val) {
                $("#akun").append("<option value='" + val.id + '|' + val.kode_rekening + "'>" + val.akun + "</option>")
            });
        },
        error: function (data) {}
    });
