...
$(document).ready(function () {
    $("#li-penatausahaan").attr("style", "display:block;");
    $("#a-penatausahaan").addClass("active");
    $("#menu-tr-pendapatan").addClass("active");
...
$(function () {
    $("#pendapatan").autocomplete({
        source: "ajax-pendapatan",
        minLength: 2,
        select: function (event, ui) {
            $("#realisasi").val(ui.item.realisasi);
            $("#pendapatan_id").val(ui.item.id);
        },
        html: true
    });
    $("#pendapatan").data("ui-autocomplete")._renderMenu = function (ul, items) {
        var that = this;
