...
function TombolBatal() {
    ...
    // remove class error
    $("#kode_kelompok").val("").removeClass('error');
    $("#kelas_id").val("").removeClass('error');
...
$(function () {
    $("#myForm").validate({
        ...
        messages: {
            kode_rekening: "Silahkan isi kode kelompok",
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (index, val) {
                $("#kelas").append("<option value='" + val.id + '|' + val.kode_rekening + "'>" + val.kelas + "</option>")
            });
        },
        error: function (data) {}
    });
