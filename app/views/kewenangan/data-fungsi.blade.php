...
@section('title','Fungsi - Kewenangan')
@section('style')
@stop
@section('content')
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Data Fungsi Kewenangan</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Fungsi Kewenangan"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    {{ Form::hidden('kewenangan_id', '',['id' => 'kewenangan_id','name' => 'kewenangan_id']) }}

                    <div class="form-group">
                        {{ Form::label('kewenangan', 'Kewenangan', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::select('kewenangan', ['' => ''],'',['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib dipilih<br/> Pilih Kewenangan dahulu","data-placement" => "top","data-html" =>
                            "true"]) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('fungsi','',['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib diisi<br/> Fungsi Kewenangan sesuai dengan PP No 43 tahun 2014","data-placement" => "top","data-html" =>
                            "true"]) }}
                        </div>
                    </div>
                       ...
                       <div id="tab-content">
                           ...
                           <thead class="cf">
                            <tr>
                                ...
                                <th class="col-md-4">Kewenangan</th>
                            ...
                            <tr>
                                ...
                                <td>{{$dt->kewenangan->kewenangan}}</td>
                                <td>{{$dt->fungsi}}</td>
                                <td>
...
<script type="text/javascript">
    var url = "{{URL::to('data-fungsi-kewenangan')}}";
</script>
{{ HTML::script('app/kewenangan/data-fungsi.js') }}
