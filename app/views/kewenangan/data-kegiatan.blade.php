...
@section('title','Kegiatan - Kewenangan')
@section('style')
@stop
@section('content')
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Data Program Kegiatan</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Program Kegiatan"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    {{ Form::hidden('program_id', '',['id' => 'program_id','name' => 'program_id']) }}
                    ...
                    <div class="form-group">
                        {{ Form::label('bidang_id', 'Bidang', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::select('bidang_id', ['' => ''],'',['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib dipilih<br/> Pilih bidang kewenangan, agar dropdown program aktif","data-placement" => "top","data-html" =>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::select('program', ['' => ''],'',['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib dipilih<br/> Pilih program kewenangan","data-placement" => "top","data-html" =>
                            "true", "disabled" => "disabled"]) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('kegiatan','',['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib diisi<br/> Program kegiatan yang akan dilaksanakan<br/> Akan muncul pada waktu penyusunan Penganggaran","data-placement" => "top","data-html" =>
                            "true"]) }}
                        </div>
                    </div>
...
<script type="text/javascript">
    var url = "{{URL::to('data-kegiatan-kewenangan')}}";
</script>
{{ HTML::script('app/kewenangan/data-kegiatan.js') }}
