...
<section class="wrapper">
    <div class="row">
        <div class="col-md-12">
            ...
            <ul class="breadcrumb">
                <li>
                    <a href="{{URL::to('data-rpjmdesa').'/'.$data->id}}">Detil RPJMDesa</a>
                </li>
                <li>
        ...
        <div class="col-md-12">
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">RPJMDesa - Misi</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Misi"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            'rows' => '3' ,
                            'data-original-title' => 'Misi Kepala Desa terpilih selama 6 Tahun merupakan penjabaran dari Visi',
                            'data-placement' => 'top' ,
                            ]) }}
                        </div>
                    </div>
...
@section('scripts')
<script>
    var url = "{{URL::to('data-misi')}}";
</script>
{{ HTML::script('app/rpjmdesa/data-misi.js') }}
