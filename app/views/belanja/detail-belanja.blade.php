...
@section('title','Pencairan Belanja')
@section('style')
@stop
@section('content')
        ...
        <div class="col-sm-12">
            ...
            <section class="panel">
                <header class="panel-heading wht-bg">
                    <h4 class="gen-case">Pelaksanaan Belanja</h4>
                </header>
                <div class="panel-body minimal">
                    <div id="form-option" class="mail-option">
                        <ul class="inbox-pagination">
                            ...
                            <a href="{{URL::to('data-belanja')}}" id="btn-back" data-original-title="Kembali"
                               data-placement="top"
...
<script type="text/javascript">
    ...
    function SimpanData() {
        ...
        OpenSpinner();
        $.ajax({
            url: '{{URL::to("data-histori-belanja")}}/' + id,
            type: 'POST',
