	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:;">Hasil</a>
                </li>
                <li>
		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading">
					Indikator Hasil : {{$data->rkpdesa->kegiatan}}<span class="tools pull-right">
...
var url = "{{URL::to('data-indikator-hasil')}}"
