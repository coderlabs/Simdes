...
@section('title','Indikator - Manfaat')
@section('style')
@stop
@section('content')
	...
	<div class="row">
		<div class="col-md-12">
			...
			<ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:;">Manfaat</a>
                </li>
			</ul>
		</div>
	</div>
		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading">
					Indikator Manfaat : {{$data->rkpdesa->kegiatan}}<span class="tools pull-right">
...
var url = "{{URL::to('data-indikator-manfaat')}}"
