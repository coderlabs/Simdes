...
@section('title','Indikator - Masukan')
@section('style')
@stop
@section('content')
	...
	<div class="row">
		<div class="col-md-12">
            ...
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:;">Masukan</a>
                </li>
                <li>
                    <a href="{{ URL::to('data-indikator-keluaran').'/'.$data->rkpdesa->indikator_keluaran_id }}">Keluaran</a>
                </li>
                <li>
		...
		<div class="col-md-12">
			<section class="panel">
				<header class="panel-heading">
					Indikator Masukan : {{$data->rkpdesa->kegiatan}}<span class="tools pull-right">
...
var url = "{{URL::to('data-indikator-masukan')}}"
