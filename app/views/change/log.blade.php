...
@section('title','Catatan Perubahan SistemAPBDesa')
@section('style')
@stop
@section('content')
{{-- content start here--}}
<section class="wrapper">
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumb">
                <li>
                    <a class="" href="{{ URL::to('dashboard') }}">Kelompok</a>
                </li>
                <li class="active">Catatan Perubahan Sistem</li>
            </ul>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Data Akun</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Akun"
                                   onfocus="this.select()"
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('akun', '', ['class' => 'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group">
...
@section('scripts')
<script>
    var url = "{{URL::to('data-perubahan-sitem')}}";
</script>
{{ HTML::script('app/change/data-perubahan-sistem.js') }}
