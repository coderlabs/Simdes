		...
		<div class="col-sm-12">
			...
			<section class="panel">
				<header class="panel-heading wht-bg">
					<h4 class="gen-case">Master Provinsi
					<form id="form-cari" action="#" class="pull-right src-position">
						<div class="input-append">
							<input id="cari" type="text" class="form-control  tooltips" placeholder="Cari : Nama Provinsi" onfocus="this.select()" data-original-title="Ketikan data yang ingin dicari, kemudian tekan [Enter]" data-placement="top" >
						</div>
					</form>
					</h4>
				</header>
				<div class="panel-body minimal">
					...
					<div class="form-group">
						{{ Form::label('kode_provinsi', 'Kode Provinsi', ['class' => 'col-md-3 control-label']) }}
						<div class="col-md-4">
							{{ Form::text('kode_provinsi','', ['class' => 'form-control']) }}
						</div>
					</div>
					<div class="form-group">
						{{ Form::label('provinsi', 'Provinsi', ['class' => 'col-md-3 control-label']) }}
						<div class="col-md-4">
							{{ Form::text('provinsi','', ['class' => 'form-control']) }}
						</div>
					</div>
					<div class="form-group">
