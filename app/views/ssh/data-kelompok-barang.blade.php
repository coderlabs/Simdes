...
@section('title','Kelompok Barang - Standar Satuan Harga')
@section('style')
@stop
@section('content')
{{-- content start here--}}
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Kelompok Barang</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Kelompok Barang"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    {{ Form::hidden('kelas_id','',['id' => 'kelas_id']) }}

                    <div class="form-group">
                        {{ Form::label('kelas', 'Kelas Barang',['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        {{ Form::label('kode_rekening', 'Kode Rekening', array('class' => 'col-md-3 control-label')) }}
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('kelompok', '', ['class' => 'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group">
...
@section('scripts')
<script>
    var url = "{{URL::to('data-kelompok-barang')}}";
    var url_kelas_barang = "{{URL::to('ajax-list-kelas-barang')}}";
</script>
{{ HTML::script('app/ssh/data-kelompok-barang.js') }}
