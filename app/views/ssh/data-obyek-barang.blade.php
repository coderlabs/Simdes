...
@section('title','Obyek Barang - Standar Satuan Harga')
@section('style')
@stop
@section('content')
{{-- content start here--}}
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Jenis Barang</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Oyek Barang"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    {{ Form::hidden('jenis_id','',['id' => 'jenis_id']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::text('obyek', '', ['class' => 'form-control'])}}
                        </div>
                    </div>
                    <div class="form-group">
...
@section('scripts')
<script>
    var url = "{{URL::to('data-obyek-barang')}}";
...
{{ HTML::script('app/ssh/data-obyek-barang.js') }}
