...
@section('title','Jenis Barang - Standar Satuan Harga')
@section('style')
@stop
@section('content')
{{-- content start here--}}
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Jenis Barang</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Jenis"
                                   onfocus="this.select()"
                ...
                <div class="panel-body minimal">
                    ...
                    {{ Form::hidden('kelompok_id','',['id' => 'kelompok_id']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            {{ Form::select('kelompok', ['' => ''],'',['class' => 'form-control','disabled' => 'disabled'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('kode_rekening', 'Kode', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-3">
