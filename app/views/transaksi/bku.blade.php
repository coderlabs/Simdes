...
@section('title','Bukti Transaksi Penerimaan')
@section('style')
        ...
        <div class="col-sm-12">
            ...
            <section class="panel">
                <header class="panel-heading wht-bg">
                    <h4 class="gen-case">Bukti Transaksi Pendapatan
                ...
                <div class="panel-body minimal">
                    <div id="form-option" class="mail-option">
                        ...
                        <a data-original-title="Cetak" data-placement="top"
                                                       href="{{URL::to('cetak-bku')}}" target="_blank"
...
@section('scripts')
<script>
    var url = "{{URL::to('laporan-bku-pendapatan')}}";
    var url_cetak_bku = "{{URL::to('cetak-bku')}}";
</script>
...
{{ HTML::script('app/transaksi/laporan-bku-pendapatan.js') }}
