...
<table class="table-text" style="padding-bottom: 20px">
    <tr style="text-align: center;font-family: Arial;font-size: 12pt; padding-bottom: 10px">
        ...
        <td class="col-md-10">
            ...
            PERINCIAN OBYEK PENGELUARAN<br/>
    ...
    <tr>
        <table class="table-list">
            <tr>
                ...
                <th class="text-center col-md-2">NOMOR BKU PENGELUARAN</th>
                <th class="text-center col-md-2">TANGGAL PENGELUARAN</th>
                <th class="text-center col-md-5">NOMOR SPP DAN BUKTI PENGELUARAN LAINNYA</th>
