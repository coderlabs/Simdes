...
<tr style="vertical-align: top">
    ...
    <td class="no-border-bottom">{{$data->tujuan}}</td>
    <td class="no-border-bottom">{{$data->lokasi}}</td>
    <td class="no-border-bottom">{{$data->sasaran}}</td>
    <td class="no-border-bottom">{{$data->target}}</td>
    @if ($data->status === 'Baru')
    <td class="text-center no-border-bottom">x</td>
    <td class="text-center no-border-bottom"></td>
    <td class="text-center no-border-bottom"></td>
    <td class="text-center no-border-bottom"></td>
    ...
    <td class="text-center no-border-bottom"></td>
    @endif
    <td class="text-center no-border-bottom">{{$data->waktu}}</td>
    <td class="text-right no-border-bottom">{{number_format($data->pagu_anggaran, 2, ',', '.')}}</td>
    <td class="no-border-bottom">{{$data->sumber_dana}}</td>
    <td class="no-border-bottom">{{$data->pejabatDesa->nama}}</td>
...
<div class="" style="font-size:10pt;text-align: justify;float: left;position: absolute">
    ...
    <br />
    5. Lembar 4 : Dikirim ke Provinsi (PMD, Bappeda dan DPRD Provinsi)
    <br />
