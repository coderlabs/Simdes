...
<div class="" style="font-size:10pt;text-align: justify;float: left;position: absolute">
    ...
    <br />
    2. Lembar 1 : Arsip Kabupaten
    <br />
    3. Lembar 2 : Dikirim ke Provinsi (PMD, Bappeda dan DPRD Provinsi)
    <br />
...
<div class="text-ttd-right">
    {{$organisasi->kab.', '.$tgl}}
    <br />
    {{($bupati['jabatan'] == 'Walikota') ? 'Walikota' : 'Bupati'}}
    <br />
    {{isset($organisasi->kab) ? strtoupper($organisasi->kab) : 'Belum diset'}}
    <br />
    <br />
    <br />
    <br />
    <br />
    <strong><u>{{isset($bupati) ? $bupati['nama'] : 'Belum diset'}}</u></strong>
</div>
</body>
</html>
