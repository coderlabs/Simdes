    ...
    <tr>
        <table class="table-list">
            ...
            <tr>
                ...
                <td class="" colspan="5"><strong>Pendapatan</strong></td>
            </tr>
            @foreach ($pendapatan as $data)
            @if(!empty($data->rincian_obyek_id))
            <tr>
                <td>{{$data->kelompok->kode_rekening}}</td>
                <td colspan="5">{{$data->kelompok->kelompok}}</td>
            </tr>
            <tr>
                <td>{{$data->jenis->kode_rekening}}</td>
                <td colspan="5">{{$data->jenis->jenis}}</td>
            </tr>
            <tr>
                <td>{{$data->obyek->kode_rekening}}</td>
                <td colspan="5">{{$data->obyek->obyek}}</td>
            </tr>
            <tr>
            ...
            @endforeach
            <tr>
                <td class="" colspan="5" style="text-align: right"><strong>Jumlah keseluruhan Pendapatan</strong></td>
