                    ...
                    <div id="form-option" class="mail-option">
                        <ul class="inbox-pagination">
                            ...
                            <button id="btn-cetak" class="btn btn-white fa fa-print tooltips"
                                    data-original-title="Cetak RKA Desa" data-placement="top"></button>
                            @endif
                        </ul>
                    </div>
                    <div id="tab-content" class="table-inbox-wrap">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-toolbar">
                                        <a href="{{URL::to('unset-rka')}}/{{$data->id.'/'.'pendapatan'}}"
                                           class="btn btn-white fa fa-minus-square" title="Unset RKA"></a>
                                        <a href="{{URL::to('data-rka-desa')}}/{{$data->id.'/'.'pendapatan'}}"
                                           class="btn btn-white fa fa-check-circle" title="Set DPA"></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-toolbar">
                                        <a href="{{URL::to('unset-rka')}}/{{$data->id.'/'.'belanja'}}"
                                           class="btn btn-white fa fa-minus-square" title="Unset RKA"></a>
                                        <a href="{{URL::to('data-rka-desa')}}/{{$data->id.'/'.'belanja'}}"
                                           class="btn btn-white fa fa-check-circle" title="Set DPA"></a>
                                    </div>
                            </tr>
                            @endforeach
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <div class="btn-toolbar">
                                        <a href="{{URL::to('unset-rka')}}/{{$data->id.'/'.'pembiayaan'}}"
                                           class="btn btn-white fa fa-minus-square" title="Unset RKA"></a>
                                        <a href="{{URL::to('data-rka-desa')}}/{{$data->id.'/'.'pembiayaan'}}"
                                           class="btn btn-white fa fa-check-circle" title="Set DPA"></a>
                                    </div>
                            </tr>
                            @endforeach
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Cetak RKA DESA</h4>
            </div>
...
<!--                    </tr>-->
                    <tr>
                        ...
                        <td><a data-original-title="Cetak Ringkasan Anggaran dan Belanja Desa" data-placement="left"
                               href="{{URL::to('rka-formulir-1')}}" target="_blank"
                               class="btn btn-white fa fa-print pull-right tooltips"></a></td>
                    </tr>
                    <tr>
                        <td>Rincian Anggaran Pendapatan Desa</td>
                        <td><a data-original-title="Cetak Rincian Anggaran Pendapatan Desa" data-placement="left"
                               href="{{URL::to('rka-formulir-2')}}" target="_blank"
                               class="btn btn-white fa fa-print pull-right tooltips"></a></td>
                    </tr>
                    <tr>
                        <td>Rincian Anggaran Belanja Tidak Langsung Desa</td>
                        <td><a data-original-title="Cetak Rincian Anggaran Belanja Ridak Langsung Desa"
                               data-placement="left" href="{{URL::to('rka-formulir-3')}}" target="_blank"
                               class="btn btn-white fa fa-print pull-right tooltips"></a></td>
                    </tr>
                    <tr>
