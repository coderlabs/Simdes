    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="" href="{{ URL::to('data-perdes-batang-tubuh') }}">Batang Tubuh</a>
                </li>
                <li>
                    <a class="current" href="javascript:;">Penutup</a>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="col-sm-12">
            ...
            <section class="panel">
                <header class="panel-heading wht-bg">
                    <h4 class="gen-case">Penutup Perdes
                ...
                <div class="panel-body minimal">
                    ...
                    <div class="form-group">
                        {{ Form::label('nomor', 'Nomor', ['class' => 'col-md-3
                        control-label']) }}
                        <div class="col-md-2">
                    ...
                    <div id="tab-content" class="table-inbox-wrap">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th class="col-md-2">Tempat Pengesahan</th>
                                <th class="col-md-2">Pengundangan</th>
                                <th class="col-md-2">Tanggal Pengesahan</th>
...
<script type="text/javascript">
    var url = "{{URL::to('data-perdes-penutup')}}";
    var url_ajax_judul = "{{URL::to('ajax-perdes-judul')}}";
</script>
{{ HTML::script('app/perdes/data-perdes-penutup.js') }}
