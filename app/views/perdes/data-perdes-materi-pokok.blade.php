...
@section('title','Materi Pokok - Perdes')
@section('style')
@stop
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:;">Materi Pokok</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <section class="panel">
                ...
                <div class="panel-body minimal">
                    ...
                    <div class="form-group">
                        {{ Form::label('bab', 'Bab', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-4">
                            {{ Form::text('bab','', ['class' => 'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::textarea('judul','', ['class' => 'form-control','rows' => '3']) }}
                        </div>
                    </div>

                    <div class="form-group">
                        {{ Form::label('pasal', 'Pasal', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-4">
                            {{ Form::text('pasal','', ['class' => 'form-control']) }}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {{ Form::textarea('uraian','', ['class' => 'form-control','rows' => '3']) }}
                        </div>
                    </div>
                    ...
                    <div id="tab-content" class="table-inbox-wrap">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th class="col-md-1">Bab</th>
                                <th class="col-md-2">Pasal</th>
...
<script type="text/javascript">
    var url = "{{URL::to('data-perdes-materi-pokok')}}";
    var url_poin = "{{URL::to('data-perdes-materi-pokok-poin')}}";
</script>
{{ HTML::script('app/perdes/data-perdes-materi-pokok.js') }}
