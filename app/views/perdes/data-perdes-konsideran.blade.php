...
@section('title','Konsideran - Perdes')
@section('style')
@stop
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="breadcrumbs-alt">
                ...
                <li>
                    <a class="current" href="javascript:;">Konsideran</a>
                </li>
                <li>
        ...
        <div class="col-sm-12">
            ...
            <section class="panel">
                <header class="panel-heading wht-bg">
                    <h4 class="gen-case">Konsideran Perdes
                ...
                <div class="panel-body minimal">
                    ...
                    <div class="form-group">
                        {{ Form::label('konsideran', 'Konsideran', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::textarea('konsideran','', ['class' => 'form-control','rows' => '3']) }}
                        </div>
                    </div>
                    ...
                    <div id="tab-content" class="table-inbox-wrap">
                        <table class="table table-hover">
                            <thead>
                            <tr>
                                <th class="col-md-9">Konsideran</th>
...
<script type="text/javascript">
    var url = "{{URL::to('data-perdes-konsideran')}}";
    var url_ajax_judul = "{{URL::to('ajax-perdes-judul')}}";
</script>
{{ HTML::script('app/perdes/data-perdes-konsideran.js') }}
