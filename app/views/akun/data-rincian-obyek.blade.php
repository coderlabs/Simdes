...
@section('title','Rincian Obyek - APBDesa')
@section('style')
@stop
@section('content')
{{-- content start here--}}
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @endif
                ...
                <li class="active">Rincian Obyek</li>
            </ul>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Data Akun Rincian Obyek APBDesa</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Rincian Obyek"
                                   onfocus="this.select()"
                ...
                <div class="panel-body">
                    ...
                    {{ Form::hidden('obyek_id', '',['id' => 'obyek_id','name' => 'obyek_id']) }}

                    <div class="form-group">
                        {{ Form::label('obyek', 'Obyek', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-3">
                            {{ Form::select('obyek', ['' => ''],'',['class' => 'form-control']) }}
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        {{ Form::label('rincian_obyek', 'Obyek', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-6">
...
@section('scripts')
<script>
    var url = "{{URL::to('data-rincian-obyek')}}";
    var url_obyek = "{{URL::to('ajax-list-obyek')}}";
</script>
{{ HTML::script('app/akun/data-rincian-obyek.js') }}
