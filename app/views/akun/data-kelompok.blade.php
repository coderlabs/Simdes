...
@section('title','Akun Kelompok - APBDesa')
@section('style')
@stop
@section('content')
{{-- content start here--}}
        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                <header class="panel-heading">
                    <div class="ellipsis">Data Akun Kelompok APBDesa</div>
                        <span id="form-cari" class="tools pull-right">
                            <input id="cari" type="text" class="form-control tooltips input-widget" placeholder="Cari : Akun Kelompok"
                                   onfocus="this.select()"
                ...
                <div class="panel-body">
                    ...
                    {{ Form::hidden('akun_id', '',['id' => 'akun_id','name' => 'akun_id']) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            {{ Form::select('akun', ['' => ''],'',['class' => 'form-control', 'id' => 'akun'])}}
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            "true","onfocus"=> "this.select()"]) }}
                        </div>
                    </div>
                    <div class="form-group">
                        {{ Form::label('kelompok', 'Kelompok', ['class' => 'col-md-3 control-label']) }}
                        <div class="col-md-6">
                            {{ Form::text('kelompok', '', ['class' => 'form-control tooltips',
                            "data-original-title" => "Wajib diisi<br/> Kelompok Akun","data-placement" => "top","data-html" =>
                            "true","onfocus"=> "this.select()"]) }}
                        </div>
                    </div>
                    <div class="form-group">
...
@section('scripts')
<script>
    var url = "{{URL::to('data-kelompok')}}";
    var url_akun = "{{URL::to('ajax-data-akun')}}";
</script>
{{ HTML::script('app/akun/data-kelompok.js') }}
