                        ...
                        <table class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-3">Pendapatan</th>
...
<script type="text/javascript">
    var url = "{{URL::to('data-pendapatan')}}";
    var url_set_rka = "{{URL::to('pendapatan-set-rka')}}";

</script>
{{ HTML::script('app/pendapatan/data-pendapatan.js') }}
